...
public class Snake2Ctrl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (Input.GetKeyDown(KeyCode.DownArrow) && direction != Vector2.down && direction != Vector2.up)
        {
        ...
        else if (Input.GetKeyDown(KeyCode.RightArrow) && direction != Vector2.right && direction != Vector2.left)
        {
