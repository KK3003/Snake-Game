...
public class SpawnCtrl : MonoBehaviour
{
    ...
    public GameObject spawnObject;// score;   // to spawn
   ...
   //public float minTimeScore = 10, maxTimeScore = 15; // for double score
    ...
    void Spawn()
    {
        spawnObject.transform.position = new Vector3(Random.Range(left.transform.position.x, right.transform.position.x),
